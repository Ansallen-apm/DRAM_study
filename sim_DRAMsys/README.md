...
本目錄 (`sim_DRAMsys/`) 包含了所有使用 [DRAMSys](https://github.com/tukl-msd/DRAMSys) 模擬器分析 **LPDDR4-6400** 記憶體效能的相關檔案、設定檔與腳本。

如果您想了解如何執行模擬與產生 Trace 檔案，請參閱：
👉 **[DRAMSys 模擬操作指南 (SIM_GUIDE.md)](SIM_GUIDE.md)**
...
在高 Bank Contention 的情況下，Burst Size 對 FIFO 的效能有決定性的影響。
